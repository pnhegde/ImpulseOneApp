...
queryList=[]
query = "SELECT campaignId, date, domain, COUNT(*) AS impressions, SUM(clicked) AS clicks, SUM(clickConversion) AS clickconversions, SUM(viewConversion) AS viewconversions, (SUM(price)/1000) AS spend FROM logsnew GROUP BY campaignId, date, domain"
cur.execute(query)
rows=cur.fetchall()
for row in rows:
...
query = "SELECT campaignId, date, state, COUNT(*) AS impressions, SUM(clicked) AS clicks, SUM(clickConversion) AS clickconversions, SUM(viewConversion) AS viewconversions, (SUM(price)/1000) AS spend FROM logsnew GROUP BY campaignId, date,state"
cur.execute(query)
rows=cur.fetchall()
for row in rows:
  if row["clickconversions"]==None:
...
query = "SELECT campaignId, date, city, COUNT(*) AS impressions, SUM(clicked) AS clicks, SUM(clickConversion) AS clickconversions, SUM(viewConversion) AS viewconversions, (SUM(price)/1000) AS spend FROM logsnew GROUP BY campaignId, date,city"
cur.execute(query)
rows=cur.fetchall()
for row in rows:
  if row["clickconversions"]==None:
...
query = "SELECT campaignId, date, HOUR(time) as hour,bannerId, COUNT(*) AS impressions, SUM(clicked) AS clicks, SUM(clickConversion) AS clickconversions, SUM(viewConversion) AS viewconversions, (SUM(price)/1000) AS spend FROM logsnew GROUP BY campaignId, date, HOUR(time),bannerId"
cur.execute(query)
rows=cur.fetchall()
for row in rows:
  if row["clickconversions"]==None:
...
query = "SELECT campaignId, date, carrier, COUNT(*) AS impressions, SUM(clicked) AS clicks, SUM(clickConversion) AS clickconversions, SUM(viewConversion) AS viewconversions, (SUM(price)/1000) AS spend FROM logsnew GROUP BY campaignId, date,carrier"
cur.execute(query)
rows=cur.fetchall()
for row in rows:
  if row["clickconversions"]==None:
...
query = "SELECT campaignId, date, device, COUNT(*) AS impressions, SUM(clicked) AS clicks, SUM(clickConversion) AS clickconversions, SUM(viewConversion) AS viewconversions, (SUM(price)/1000) AS spend FROM logsnew GROUP BY campaignId, date,device"
cur.execute(query)
rows=cur.fetchall()
for row in rows:
  if row["clickconversions"]==None:
...
query = "SELECT campaignId, date, domain, state, city, COUNT(*) AS impressions, SUM(clicked) AS clicks, SUM(clickConversion) AS clickconversions, SUM(viewConversion) AS viewconversions, (SUM(price)/1000) AS spend FROM logsnew GROUP BY campaignId, date,domain, state, city"
cur.execute(query)
rows=cur.fetchall()
for row in rows:
  if row["clickconversions"]==None:
...
query = "SELECT campaignId, date, device, state, city, COUNT(*) AS impressions, SUM(clicked) AS clicks, SUM(clickConversion) AS clickconversions, SUM(viewConversion) AS viewconversions, (SUM(price)/1000) AS spend FROM logsnew GROUP BY campaignId, date,device, state, city"
cur.execute(query)
rows=cur.fetchall()
for row in rows:
  if row["clickconversions"]==None:
...
query = "SELECT campaignId, date, carrier, state, city, COUNT(*) AS impressions, SUM(clicked) AS clicks, SUM(clickConversion) AS clickconversions, SUM(viewConversion) AS viewconversions, (SUM(price)/1000) AS spend FROM logsnew GROUP BY campaignId, date,carrier, state, city"
cur.execute(query)
rows=cur.fetchall()
for row in rows:
  if row["clickconversions"]==None:
...
query = "SELECT campaignId, date, bannerId, state, city, COUNT(*) AS impressions, SUM(clicked) AS clicks, SUM(clickConversion) AS clickconversions, SUM(viewConversion) AS viewconversions, (SUM(price)/1000) AS spend FROM logsnew GROUP BY campaignId, date,bannerId, state, city"
cur.execute(query)
rows=cur.fetchall()
for row in rows:
  if row["clickconversions"]==None:
...
query = "SELECT campaignId, date, domain, HOUR(time) as hour, COUNT(*) AS impressions, SUM(clicked) AS clicks, SUM(clickConversion) AS clickconversions, SUM(viewConversion) AS viewconversions, (SUM(price)/1000) AS spend FROM logsnew GROUP BY campaignId, date, domain, HOUR(time)"
cur.execute(query)
rows=cur.fetchall()
for row in rows:
  if row["clickconversions"]==None:
...
query = "SELECT campaignId, date, domain, bannerId, COUNT(*) AS impressions, SUM(clicked) AS clicks, SUM(clickConversion) AS clickconversions, SUM(viewConversion) AS viewconversions, (SUM(price)/1000) AS spend FROM logsnew GROUP BY campaignId, date,domain, bannerId"
cur.execute(query)
rows=cur.fetchall()
for row in rows:
  if row["clickconversions"]==None:
